  ...
  $.extend($.ui.resizable.prototype, {
    ...
    _renderProxy: function() {
      ...
      if(o.proxy) {
        ...
        this.ex.appendTo("body");
        
        if (o.disableSelection)
          $.ui.disableSelection(this.ex.get(0));
    ...
    start: function(e) {
      ...
      this._renderProxy();
			...
			var curleft = parseInt(this.ex.css('left'),10) || 0, curtop = parseInt(this.ex.css('top'),10) || 0;
    ...
    stop: function(e) {
      ...
      if(o.proxy) {
        var style = { 
          width: (this.ex.width() - o.currentSizeDiff.width) + "px",
          height: (this.ex.height() - o.currentSizeDiff.height) + "px",
          top: ((parseInt(this.element.css('top'),10) || 0) + ((parseInt(this.ex.css('top'),10) - this.offset.top)||0)),
          left: ((parseInt(this.element.css('left'),10) || 0) + ((parseInt(this.ex.css('left'),10) - this.offset.left)||0))
        };
