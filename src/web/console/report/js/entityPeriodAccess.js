...
function periodWeekChart() {
	period="week";
	setRequestParams();
	var getUrl='doPeriodAccess.vpage?dsuri='+dsuri+'&id='+id+'&streamName=access_entity_period_week&random='+Math.random();
...
function periodThisMonth(){
	period="thismonth";
	setRequestParams();
	var getUrl='doPeriodAccess.vpage?dsuri='+dsuri+'&id='+id+'&streamName=access_entity_period_curmonth&random='+Math.random();
...
function periodMonth(month){
	period="month";
	setRequestParams();
	var getUrl='doPeriodAccess.vpage?dsuri='+dsuri+'&id='+id+'&streamName=access_entity_period_month&month='+month+'&random='+Math.random();

	loadData(getUrl);
}
//点击指定日期统计时调用的方法
function periodBydate(entityId){
	period="period";
	setRequestParams();
	...
	var getUrl='doPeriodAccess.vpage?dsuri='+dsuri+'&id='+id+'&streamName=access_entity_period_date&startDate='+start_date+'&endDate='+end_date+'&random='+Math.random();
	document.getElementById("allRadio").checked = true;
...
function periodAndoperation(operation){
	...
	var getUrl='';
	if(period=='week'){
		getUrl='doPeriodAccess.vpage?dsuri='+dsuri+'&id='+id+'&operation='+operation+'&streamName=access_entity_period_week&random='+Math.random();
	}
	if(period=='period'){
		var start_date=document.getElementById("Text1").value;
		var end_date=document.getElementById("Text2").value;
		getUrl='doPeriodAccess.vpage?dsuri='+dsuri+'&id='+id+'&operation='+operation+'&streamName=access_entity_period_date&startDate='+start_date+'&endDate='+end_date+'&random='+Math.random();
	}
	if(period=='month'){
		...
		getUrl='doPeriodAccess.vpage?dsuri='+dsuri+'&id='+id+'&operation='+operation+'&streamName=access_entity_period_month&month='+month+'&random='+Math.random();
	}
	if(period=='thismonth'){
		getUrl='doPeriodAccess.vpage?dsuri='+dsuri+'&id='+id+'&operation='+operation+'&streamName=access_entity_period_curmonth&random='+Math.random();
	}
