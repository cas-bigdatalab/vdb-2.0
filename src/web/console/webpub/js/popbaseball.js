  ...
  $.baseball=function(p){
	 var  cols=$(p.accepter),//accepter集
	      ...
	      befordrag=function(v){
	      	 ...
	      	 try{
		      	  if((v.innerText=="修改")||(v.innerText=="删除"))
		      	  {
		      	  	v.click();
		      	  	return;
		      	  }
			  ...
			  try{
		      	  if((v.target.innerText=="修改")||(v.target.innerText=="删除"))
		      	  {
		      	  	v.target.click();
		      	  	return;
		      	  }
		  ...
		  selectBase=function(x,y){
			  ...
			  for(var i =0,el;el=base[2][i];i++){
			   ...
			   if(base[2].length==0){
				   tip.css({"width":base[3].width(),"height":4,"left":base[3].offset().left,"top":base[3].offset().top});
				   m.lonely=base[3];
				   }else{
				   m.lonely=null;  
			...
			niceShock=function(o,n,u){
				if(n==1){tip.css({"width":$(o).width(),"height":4,"left":$(o).offset().left,"top":$(o).offset().top-4})}
				else if(n==2){tip.css({"width":4,"height":$(o).height(),"left":$(o).offset().left+$(o).width(),"top":$(o).offset().top})}
				else if(n==3){tip.css({"width":$(o).width(),"height":4,"left":$(o).offset().left,"top":$(o).offset().top+$(o).height()})}
				else{tip.css({"width":4,"height":$(o).height(),"left":$(o).offset().left-4,"top":$(o).offset().top})};
