package 
{
	...
	public class titleWindowborderBG extends HaloBorder 
	{
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			g.beginGradientFill("linear", fillColors, [.65, .85, .75], [0, 127, 255], m);
			
			g.lineStyle(3,0xCCCCCC,.9);
			g.lineGradientStyle("linear", borderFillColors, [1,.3], [0, 255], n);
									
			GraphicsUtil.drawRoundRectComplex(g, e.left + 1, e.top, w - 3, h - 2, 16, 16, 16, 16);
			g.endFill(); 
