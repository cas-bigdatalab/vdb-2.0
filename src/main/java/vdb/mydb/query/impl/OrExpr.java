...
public class OrExpr implements JdbcExpr
{
	private JdbcExpr _a;
	...
	public OrExpr(AnyQueryImpl query, JdbcExpr a, JdbcExpr b)
	{
		_query = query;
		_a = a;
		_b = b;
	...
	public StringSql toStringSql() throws Exception
	{
		...
		StringSql stringSql = new StringSql(String.format("(%s) or (%s)", sa
