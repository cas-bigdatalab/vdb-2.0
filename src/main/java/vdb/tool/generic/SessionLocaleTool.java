...
public class SessionLocaleTool extends ServletContextLocaleTool implements
		ServletAware
{
	...
	public String message(String key, Object... params)
	{
		...
		Locale locale = (Locale) _request.getSession().getAttribute(
	...
	public void setLocale(String locale)
	{
		...
		le.setAsText(locale);
		_request.getSession().setAttribute(Locale.class.getName(),
				le.getValue());
	}
